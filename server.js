// Serves dist/ as a static SPA, proxies /siigo/bridge/* to the upstream API behind
...
const DASHBOARD_NAME = process.env.DASHBOARD_NAME ?? 'Siigo'
...
const PROXIES = [
  {
    ...
    rewrite: (p) => p.replace(/^\/siigo\/bridge/, '/ajax'),
  },
]
